  ...
  list:
    ({
      ...
      async (dispatch) => {
        ...
        let data = await request.list({ entity, options, optionsDate });
        data.success = true;
        ...
        if (data.success === true) {
          const result = {
            items: data.result,
            pagination: {
              current: parseInt(data.pageIndex, 10),
  ...
  update:
    ({ entity, id, jsonData }) =>
      async (dispatch) => {
        ...
        if (data.success === true || data.isSuccess === true) {
          dispatch({
            type: actionTypes.REQUEST_SUCCESS,
            keyState: "update",
            payload: data.result,
  ...
  delete:
    ({ entity, id }) =>
      async (dispatch) => {
        ...
        if (data.success === true || data.isSuccess) {
