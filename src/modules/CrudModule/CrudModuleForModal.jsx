...
import DataTableForModal from '@/components/DataTable/DataTableForModal';
...
function CrudModuleForModal({ config, createForm, updateForm, withUpload = false }) {
  const dispatch = useDispatch();
  ...
  return (
    ...
    >
      <DataTableForModal config={config} formElements={updateForm} />
     
    </CrudLayout>
  );
}

export default CrudModuleForModal;
